...
fn load_all_dependencies(
    ...
    fn load_all_dependencies_recursive(
        ...
        // held by an outer recursive frame — otherwise a diamond `DT_NEEDED`
        // graph deadlocks, e.g.:
        //
        ...
        // safe: an ancestor by definition cannot have been loaded by a prior
        // iteration of the same frame's dependency list.
